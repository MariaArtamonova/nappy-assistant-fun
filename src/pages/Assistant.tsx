...
import { Brain, Heart, CheckCircle2, CreditCard, CheckCheck, MessageSquare, Star, SparkleIcon, MessageCircle, Baby, Image } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        {/* Entertainment content added to Assistant page */}
